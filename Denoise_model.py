...
X_train_arr = np.load('./data/noisy_px/X_train') # recommenended total batch size is over than 500,000 samples
Y_train_arr = np.load('./data/noisy_px/Y_train')
X_valid_arr = np.load('./data/noisy_px/X_valid')
Y_valid_arr = np.load('./data/noisy_px/Y_valid')
